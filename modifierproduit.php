...
mysqli_query($conn,"UPDATE  produit set   prix=$p , quantite=$q , designation='$d', promotion=$pr ,code_cat = $cat where ref_produit like '$r' ;") or die(mysqli_error($conn));	
...
<li>
    ...
    <span>MODIFIER LA REFERENCE DU PRODUIT </span>
</li>
<li>
    <label for="designation">DESIGNATION</label>
    <input type="text" name="designation" maxlength="100">
    <span>MODIFIER UNE DESIGNATION DU PRODUIT</span>
</li>
<li>
...
<li>
    ...
    <span>MODIFIER LA QUANTITE</span>
</li>
<li>
...
<li>
    <input type="submit" value="MODIFIER LE PRODUIT "  name="modifier" >
</li>
</ul>
</form>
</body> 
