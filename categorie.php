...
<?php 
	...
	$rscat=mysqli_query($conn,$req)or die ("error categories") ; ?>
<table border="0">
...
<table id="keywords" cellspacing="0" cellpadding="0">
 <thead>
 <tr>
        <th><span>CATEGORIES</span></th></tr>
	</tr>
   
	<?php while ($cat = mysqli_fetch_assoc($rscat)) {?>
      <tr>
        <th><span><a href="index.php?idCat=<?php echo($cat['code_cat'])?>" ><?php echo($cat['nom_cat'])	?>	</a></span></th></tr>
	</tr>
